...
class TwoBodyOperatorChannel : public TwoBodySpace {
    ...
    public:
        ...
        double get_2bme(int idxbra, int idxket);
        double get_2bme_orbit_indices(int a, int b, int c, int d);
        double get_2bme_orbits(Orbit oa, Orbit ob, Orbit oc, Orbit od);
...
class TwoBodyOperator : public TwoBodyOperatorChannel {
    ...
    public:
        ...
        double get_2bme(int ichbra, int ichket, int idxbra, int idxket);
        double get_2bme_orbit_indices(int ichbra, int ichket, int a, int b, int c, int d);
        double get_2bme_orbits(int ichbra, int ichket, Orbit oa, Orbit ob, Orbit oc, Orbit od);
        double get_2bme_orbitsJ(Orbit oa, Orbit ob, Orbit oc, Orbit od, int Jab, int Jcd);
        double get_2bme_orbit_indicesJ(int a, int b, int c, int d, int Jab, int Jcd);
